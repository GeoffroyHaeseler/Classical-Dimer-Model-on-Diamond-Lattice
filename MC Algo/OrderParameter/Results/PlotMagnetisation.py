...
for i in range(len(FileNames)):
    ...
    y1 = np.loadtxt(File_Name + '.txt', skiprows=1, usecols=(9))
    y2 = np.loadtxt(File_Name + '.txt', skiprows=1, usecols=(12))
    y3 = np.loadtxt(File_Name + '.txt', skiprows=1, usecols=(15))
...
print('saving figure')
fig.tight_layout()
fig.savefig('KT3TiltedMagnetisation.png')
plt.clf()
plt.close()
