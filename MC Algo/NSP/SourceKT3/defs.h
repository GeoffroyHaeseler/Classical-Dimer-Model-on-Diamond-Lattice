...
constexpr double Ti = 4; //Initial temperature

//Defines the number of steps needed to equilibrate the lattice.
constexpr int Neq = 2000;

//How the code should be run?
constexpr bool DoYouWantNeutronScatteringPlot = true; //true = yes    false = no
