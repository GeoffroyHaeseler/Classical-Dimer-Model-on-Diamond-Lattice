...
theta_c = [0.79609718166, 0.94105126021, 1.08600533877, 1.23095941733]
...
for i in range(len(FileNames)):
    ...
    y = np.loadtxt(File_Name + '.txt', skiprows=1, usecols=(9))

    axes[0].plot(x,y,'-+')


axes[0].set_xlabel(r'$T$', fontsize=24)
axes[0].set_ylabel(r'$m_{\hat{x}}$', fontsize=24)
...
print('saving figure')
fig.tight_layout()
fig.savefig('KT3TiltedMagnetisationX.png')
plt.clf()
plt.close()
