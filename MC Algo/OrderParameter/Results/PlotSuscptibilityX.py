...
LegendList.append(r'Curie Law $\chi=0.22/t$')
...
for i in range(len(FileNames)):
    ...
    y = np.loadtxt(File_Name + '.txt', skiprows=1, usecols=(10))
...
axes[0].set_ylabel(r'$\chi_{\hat{x}}$', fontsize=24)
...
ax1storder.set_ylim(0, 0.5)
ax1storder.set_yticks([0, 0.25, 0.5])
...
ax1storder.set_ylim(0, 0.75)
ax1storder.set_yticks([0, 0.25, 0.5, 0.75])
ax1storder.yaxis.tick_right()
...
print('saving figure')
fig.tight_layout()
fig.savefig('KT3TiltedSusceptibilityX.png')
plt.clf()
plt.close()
