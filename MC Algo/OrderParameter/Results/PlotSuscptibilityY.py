...
for i in range(len(FileNames)):
    ...
    y = np.loadtxt(File_Name + '.txt', skiprows=1, usecols=(13))
...
axes[0].set_ylabel(r'$\chi_{\hat{y}}$', fontsize=24)
...
ax1storder.set_ylim(0, 0.1)
ax1storder.set_yticks([0, 0.05, 0.1])
...
ax1storder.set_ylim(0, 0.2)
ax1storder.set_yticks([0, 0.05, 0.1, 0.15, 0.2])
ax1storder.yaxis.tick_right()
...
ax1storder.set_ylim(0, 1.5)
ax1storder.set_yticks([0, 0.5, 1, 1.5])
ax1storder.yaxis.tick_right()
...
print('saving figure')
fig.tight_layout()
fig.savefig('KT3TiltedSusceptibilityY.png')
plt.clf()
plt.close()
